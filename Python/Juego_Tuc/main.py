...
from constantes import SCREEN_WIDTH, SCREEN_HEIGTH, ASSETS_PATH
...
def mostrar_imagen_inicial(screen, imagen_path, duracion):
    ...
    imagen = pygame.transform.scale(imagen, (SCREEN_WIDTH, SCREEN_HEIGTH))
...
def main():
    ...
    fondo2 = pygame.transform.scale(fondo2, (SCREEN_WIDTH, SCREEN_HEIGTH))

    fondo3 = pygame.image.load(os.path.join(ASSETS_PATH, 'images', 'fondo3.jpg'))
    fondo3 = pygame.transform.scale(fondo3, (SCREEN_WIDTH, SCREEN_HEIGTH))
    ...
    pos_y_game_over = SCREEN_HEIGTH // 2 - texto_game_over.get_height() // 2 - 20  # Ajusta el margen vertical

    pos_x_mensaje = SCREEN_WIDTH // 2 - texto_mensaje.get_width() // 2
    pos_y_mensaje = SCREEN_HEIGTH // 2 + texto_game_over.get_height() // 2 + 20  # Ajusta el margen vertical
